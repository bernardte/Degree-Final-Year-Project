  ...
  const RoomTable = ({
    ...
    const handleEdit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        // Append amenities (if array or object)
        // Assuming amenities is array of strings:
        ...
        if (selectedRoom.images) {
          if (selectedRoom.images instanceof File) {
            formData.append("images", selectedRoom.images);
          } else if (Array.isArray(selectedRoom.images)) {
            selectedRoom.images.forEach((file: File) => {
