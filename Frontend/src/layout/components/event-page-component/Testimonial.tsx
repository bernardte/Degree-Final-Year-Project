const Testimonial = () => {
  return (
    <>
      ...
      <div className="rounded-2xl bg-white p-6 shadow-lg">
        <div className="mb-4 flex items-center">
          ...
          <div>
            ...
            <p className="text-blue-600">Wedding Reception</p>
          </div>
        </div>
        <div className="mb-4 text-4xl text-blue-300">❝</div>
        <blockquote className="mb-4 text-gray-600 italic">
          "Our wedding day was absolutely perfect! The team went above and
      ...
      {/* Testimonial 2 - Corporate */}
      <div className="rounded-2xl bg-white p-6 shadow-lg">
        <div className="mb-4 flex items-center">
          <div className="mr-4 h-12 w-12 rounded-full bg-gradient-to-r from-blue-400 to-cyan-400"></div>
          <div>
            <p className="font-semibold">Michael Chen</p>
            <p className="text-blue-600">Corporate Conference</p>
          </div>
        </div>
        <div className="mb-4 text-4xl text-blue-300">❝</div>
        <blockquote className="mb-4 text-gray-600 italic">
          "Our annual conference was a tremendous success thanks to the hotel's
      ...
      {/* Testimonial 3 - Private Party */}
      <div className="rounded-2xl bg-white p-6 shadow-lg">
        <div className="mb-4 flex items-center">
          {/* <div className="mr-4 h-12 w-12 rounded-full bg-gradient-to-r from-blue-400 to-cyan-400"></div> */}
          <div>
            <p className="font-semibold">Emma Rodriguez</p>
            <p className="text-blue-600">Birthday Celebration</p>
          </div>
        </div>
        <div className="mb-4 text-4xl text-blue-300">❝</div>
        <blockquote className="mb-4 text-gray-600 italic">
          "My 40th birthday party was beyond expectations! The venue was
